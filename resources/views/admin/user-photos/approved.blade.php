...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Foto Pengunjung (Disetujui)</h1>
    </div>

    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Daftar Foto Disetujui</h6>
            <div>
                <a href="{{ route('admin.user-photos.index') }}" class="btn btn-sm btn-warning">Menunggu Persetujuan</a>
                <a href="{{ route('admin.user-photos.rejected') }}" class="btn btn-sm btn-danger">Foto Ditolak</a>
            </div>
        </div>
        <div class="card-body">
            @if($photos->count() > 0)
            ...
            <div class="alert alert-info">
                Tidak ada foto yang disetujui saat ini.
            </div>
            @endif
        </div>
    </div>
